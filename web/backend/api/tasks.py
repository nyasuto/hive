...
async def get_all_tasks(
    ...
    try:
        ...
        status_filter = (
            status
            if status in ["pending", "in_progress", "completed", "failed", "cancelled"]
            else None
        )
...
async def get_task(task_id: str):
    ...
    try:
        ...
        with db_manager.get_connection() as conn:
            ...
            from models.schemas import Priority, TaskStatus
...
async def create_task(task_request: TaskCreateRequest):
    ...
    try:
        ...
        task_data = {
            ...
            "metadata": {"created_via": "web_dashboard", "web_created": True},
        }
